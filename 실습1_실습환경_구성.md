...
**저는 이 서버에 몇몇 필수 소프트웨어들을 이미 설치해 두었습니다.** 그 이유는 설치 시간을 최소하하고, 설치 등에서 발생할 수 있는 네트워크 속도 저하 문제 또는 기타 리스크 등을 제거하기 위해서입니다. 그러므로 내용을 잘 읽으면서 불필요한 작업을 중복 수행하지 않도록 조심해 주십시오.
